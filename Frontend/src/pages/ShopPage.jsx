...
export default function ShopPage() {
  const {productState: {sort, category, rating, brand, searchQuery}} = CartState();
  ...
  return (
    <div id="top" data-aos="fade-in" className="flex justify-content-center max-w-7xl mx-auto px-6 py-10 gap-8">
